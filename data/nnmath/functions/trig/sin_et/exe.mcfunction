...
execute as @e[type=area_effect_cloud,tag=nnmath_trig,limit=1] at @s run function nn_math:trig/sin_et/private/calc
execute if score flag_no_aec nnmath_trig matches 1 run function nn_math:trig/sin_et/private/no_aec
